...
function UserSlice({ user }: any) {
  console.log(user)
    return (
    <div className=" mx-auto w-11/12 h-16 m-auto flex items-center bg-[#F6F6F6] p-5 pl-2 mt-2 transition-all rounded-md mt-5">
      <Link to={"/"}> <img className="w-5 h-5 mr-3 " src={ArrowLeft} alt="" /> </Link>
